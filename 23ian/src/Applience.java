...
public class Applience extends ElectronicProduct {
public static final int DEFAULT_QUARANTEE=6;

    public Applience(String name, double price, int quantity) {
        super(DEFAULT_QUARANTEE,name, price, quantity);
    }

    public Applience(String name, double price, int quantity, String ageRestriction) {
