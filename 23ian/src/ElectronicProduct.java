...
public class ElectronicProduct extends Product {
    private int quaranteePeriod;

    public ElectronicProduct(int quaranteePeriod,String name, double price, int quantity) {
        super(name, price, quantity);
        this.quaranteePeriod = quaranteePeriod;
    }

    public ElectronicProduct(int quaranteePeriod,String  name, double price, int quantity, String ageRestriction) {
        super(name, price, quantity, ageRestriction);
        this.quaranteePeriod = quaranteePeriod;
    }

    public int getQuaranteePeriod() {
        return quaranteePeriod;
    }

    public void setQuaranteePeriod(int quaranteePeriod) {
        this.quaranteePeriod = quaranteePeriod;
    }
