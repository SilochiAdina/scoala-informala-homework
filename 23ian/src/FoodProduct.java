...
public class FoodProduct extends Product implements IExpirable {
    private LocalDate expirationDate;

    public FoodProduct(String name, double price, int quantity, LocalDate expirationDate) {
    ...
    public double getPrice(){
        if(ChronoUnit.DAYS.between(LocalDate.now(), expirationDate)<15) {
